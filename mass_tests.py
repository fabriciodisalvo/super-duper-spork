...
def print_stats(stats_list):
    logfile = 'test_log_file' + stats_list[0][0] + '.txt'
    ...
    for i in stats_list:
        rolling_sum += i[1]
        rolling_count += 1
        output_string = output_string + "|" + i[0].center(27) + "|  " + str(i[1]).ljust(29) + "|" + '\n'
    output_string = output_string + ' -' * 30 + '\n'
    output_string = output_string + "|" + 'Total processes : {}'.format(rolling_count).center(59) + "|" + '\n'
    output_string = output_string + "|" + 'Total time of process : {}'.format(rolling_sum).center(59) + "|" + '\n'
    output_string = output_string + "|" + 'Average time of process : {}'.format(rolling_sum / rolling_count).center(59) + "|" + '\n'
    output_string = output_string + ' -' * 30 + '\n'
